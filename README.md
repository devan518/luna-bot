...
> **Note:** for some reason adding the character "/" in the name in /quest will just say "the application did not respond", refrain from doing this until it is patched!
